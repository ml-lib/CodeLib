...
class TestMetrics(unittest.TestCase):
    ...
    def test_rsq(self):
        ...
        y = np.array([3, 8, 10, 17, 24, 27], dtype=float)
        y_hat = np.array([2, 8, 10, 13, 18, 20], dtype=float)
        exp_op = 0.772
    ...
    def test_mse(self):
        ...
        y = np.array([34, 37, 44, 47, 48, 48, 46, 43, 32, 27, 26, 24],
                     dtype=float)
        y_hat = np.array([37, 40, 46, 44, 46, 50, 45, 44, 34, 30, 22, 23],
                         dtype=float)
        exp_op = 5.917
    ...
    def test_mae(self):
        ...
        y = np.array([12, 13, 14, 15, 15, 22, 27], dtype=float)
        y_hat = np.array([11, 13, 14, 14, 15, 16, 18], dtype=float)
        exp_op = 2.429
